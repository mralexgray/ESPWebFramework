...
// f_memcmp
// both s1 and s2 can be stored in Flash or/and in RAM
int32_t FUNC_FLASHMEM f_memcmp(void const *s1, void const *s2,
                               uint32_t length) {
  return t_memcmp(ByteIterator((uint8_t const *)s1),
                  ByteIterator((uint8_t const *)s2), length);
}
...
// f_memcpy
// source can be stored in Flash or/and in RAM
void *FUNC_FLASHMEM f_memcpy(void *destination, void const *source,
                             uint32_t length) {
...
char const *FUNC_FLASHMEM f_strstr(char const *str, char const *strEnd,
                                   char const *substr) {
  return t_strstr(CharIterator(str), CharIterator(strEnd), CharIterator(substr))
      .get();
}
...
/////////////////////////////////////////////////////////////////////////
// isdigit
bool FUNC_FLASHMEM isdigit(char c) { return (c >= '0' && c <= '9'); }
...
/////////////////////////////////////////////////////////////////////////
// isupper
bool FUNC_FLASHMEM isupper(char c) { return c >= 'A' && c <= 'Z'; }

/////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////
// islower
bool FUNC_FLASHMEM islower(char c) { return c >= 'a' && c <= 'z'; }
