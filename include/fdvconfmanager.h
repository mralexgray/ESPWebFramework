...
public:
  ...
  static void setAccessPointParams(char const *SSID, char const *securityKey,
                                   uint8_t channel,
                                   WiFi::SecurityProtocol securityProtocol,
                                   bool hiddenSSID);

  static void getAccessPointParams(char const **SSID, char const **securityKey,
                                   uint8_t *channel,
                                   WiFi::SecurityProtocol *securityProtocol,
                                   bool *hiddenSSID);
  ...
  static void setClientIPParams(bool staticIP, char const *IP,
                                char const *netmask, char const *gateway);

  // IP, netmask, gateway valid only if staticIP = true
  static void getClientIPParams(bool *staticIP, char const **IP,
                                char const **netmask, char const **gateway);

  //// Access point IP parameters

  static void setAccessPointIPParams(char const *IP, char const *netmask,
                                     char const *gateway);

  static void getAccessPointIPParams(char const **IP, char const **netmask,
                                     char const **gateway);

  //// DHCP server parameters

  static void setDHCPServerParams(bool enabled, char const *startIP = NULL,
                                  char const *endIP = NULL);

  static void getDHCPServerParams(bool *enabled, char const **startIP,
                                  char const **endIP);
  ...
  static void setUARTParams(uint32_t baudRate, bool enableSystemOutput,
                            SerialService serialService);

  static void getUARTParams(uint32_t *baudRate, bool *enableSystemOutput,
                            SerialService *serialService);
  ...
  static void setGPIOParams(uint32_t gpioNum, bool configured, bool isOutput,
                            bool pullUp, bool value);

  static void getGPIOParams(uint32_t gpioNum, bool *configured, bool *isOutput,
                            bool *pullUp, bool *value);

  //// Date-time parameters

  static void setDateTimeParams(int8_t timezoneHours, uint8_t timezoneMinutes,
                                char const *defaultNTPServer);

  static void getDateTimeParams(int8_t *timezoneHours, uint8_t *timezoneMinutes,
                                char const **defaultNTPServer);

  static DateTime getBootDateTime(bool set = false,
                                  DateTime const &value = DateTime());
...
struct HTTPHelperConfiguration {
  ...
  static void getDNSServer(HTTPTemplateResponse *response,
                           IPAddress::IPAddressStr &DNS1str,
                           IPAddress::IPAddressStr &DNS2str);
  static void setDNSServer(HTTPTemplateResponse *response);

  static void getDateTime(HTTPTemplateResponse *response, char *dateStr,
                          char *timeStr);
  ...
  static void getAPWiFiParams(HTTPTemplateResponse *response,
                              APtr<char> &APCHStr, APtr<char> &APSECStr);
...
struct HTTPNetworkConfigurationResponse : public HTTPTemplateResponse {
  HTTPNetworkConfigurationResponse(HTTPHandler *httpHandler,
                                   char const *filename);
...
struct HTTPServicesConfigurationResponse : public HTTPTemplateResponse {
  HTTPServicesConfigurationResponse(HTTPHandler *httpHandler,
                                    char const *filename);
...
struct HTTPWizardConfigurationResponse : public HTTPTemplateResponse {
  HTTPWizardConfigurationResponse(HTTPHandler *httpHandler,
                                  char const *filename);
...
//   gpio  = 0..16
//   val   = 0..1
//   store = 0..1 (0=not store in flash, 1= store in flash) (if not present is
//   like "not store")
// If cmd="conf":
//   gpio  = 0..16
//   mode  = "in".."out"
